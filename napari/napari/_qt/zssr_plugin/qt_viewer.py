...
from napari.napari.components._interaction_box_mouse_bindings import (
    InteractionBoxMouseBindings,
)
from napari.napari.components.camera import Camera
from napari.napari.components.layerlist import LayerList
from napari.napari.layers.base.base import Layer
from napari.napari.plugins import _npe2
from napari.napari.plugins.utils import get_potential_readers
from napari.napari.utils import config, perf
from napari.napari.utils._proxies import ReadOnlyWrapper
from napari.napari.utils.action_manager import action_manager
from napari.napari.utils.colormaps.standardize_color import transform_color
from napari.napari.utils.history import (
    get_open_history,
    get_save_history,
    update_open_history,
    update_save_history,
)
from napari.napari.utils.interactions import (
...
from napari.napari.utils.io import imsave
from napari.napari.utils.key_bindings import KeymapHandler
from napari.napari.utils.misc import in_ipython
from napari.napari.utils.theme import get_theme
from napari.napari.utils.translations import trans
...
from napari.napari._vispy import (  # isort:skip
    VispyAxesOverlay,
    VispyCamera,
    VispyCanvas,
...
if TYPE_CHECKING:
    from napari.napari.components import ViewerModel
    from npe2.manifest.contributions import WriterContribution

from napari.napari.settings import get_settings
from napari.napari.utils.io import imsave_extensions
...
class QtViewer(QSplitter):
    ...
    def _open_files_dialog(self):
        ...
        if (filenames != []) and (filenames is not None):
            print("my name file is "+str(filenames))
            root = tk.Tk()
            lbl = ImageLabel(root)
            lbl.pack()
            lbl.load("C:\\Users\\adirm\\Desktop\\loadGif.gif")
            root.mainloop()
...
if TYPE_CHECKING:
    from napari.napari.components.experimental.remote import RemoteManager
